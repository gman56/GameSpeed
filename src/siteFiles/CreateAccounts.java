...
public class CreateAccounts extends HttpServlet {
	...
	protected void displayRegistration(HttpServletRequest request,
		...
		pw.print("<h2 class='title meta'><a style='font-size: 24px;'>Create Customer Accounts</a></h2>"
				+ "<div class='entry'>"
				+ "<div style='width:400px; margin:25px; margin-left: auto;margin-right: auto;'>");
		if (error)
			pw.print("<h4 style='color:red'>"+error_msg+"</h4>");
		pw.print("<form method='post' action='createAccounts'>"
