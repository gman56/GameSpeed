...
public class Registration extends HttpServlet {
	...
	protected void displayRegistration(HttpServletRequest request,
		...
		pw.print("<h2 class='title meta'><a style='font-size: 24px;'>Register</a></h2>"
				+ "<div class='entry'>"
		...
		pw.print("<form method='post' action='Registration'>"
				...
				+ "</td></tr><tr><td>"
				+ "<h3>User Type</h3></td><td><select name='usertype' style='height:40px;' class='input'><option value='customer' selected>Customer</option><option value='manager'>Store Manager</option><option value='retailer'>Salesman</option></select>"
				+ "</td></tr></table>"
